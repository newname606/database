<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"C:\Users\gaming\Desktop\competition13/application/competition\view\project\index.html";i:1593386156;s:88:"C:\Users\gaming\Desktop\competition13/application/competition\view\public\Baseindex.html";i:1593348024;}*/ ?>
...
<div class="cl pd-5 bg-1 bk-gray mt-20">
    <a href="<?php echo url('save'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加</a></span>&nbsp;&nbsp;
    <a href="<?php echo url('PHPExcel/index'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>下载数据</a>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td class="td-manage">
            <a title="编辑" href="<?php echo url('save',array('id'=>$row['id'])); ?>" class="ml-5"
               style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>
            </a> <a title="删除" href="<?php echo url('del',array('id'=>$row['id'])); ?>" class="ml-5"
