<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\Users\gaming\Desktop\competition12\public/../application/home\view\intro\index.html";i:1593343828;s:79:"C:\Users\gaming\Desktop\competition12\public/../application/home\view\base.html";i:1593346936;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="content">
        ...
        <div class="sub-content">
            ...
            <div class="sub-content-info-wrap" style="display: none;">
                <div class="sub-content-info">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 四川省内企事业单位、专业组织、团队或个人可以报名参赛（联合参赛的至少应有一家为四川省内的，
                    <br />由牵头单位报名）。
                </div>
                <div class="sub-content-info">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 参赛单位、团队或个人无不良记录。
                </div>
            </div>
            <div class="sub-content-info-wrap" style="display: none;">
                <div class="sub-content-info">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 参赛项目面向云XR、工业互联网、智慧生活、医疗健康、智慧金融、智慧商业、智慧传播、智慧交通等重点领域，与我省相关产业相结合。
                </div>
                <div class="sub-content-info">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 参赛项目的创意、产品、技术及相关专利归属参赛单位、团队或个人，无知识产权纠纷。
                </div>
                <div class="sub-content-info">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 参赛者应严格遵守法律法规，不得剽窃、侵夺他人创新成果，不得利用不正当手段获取参赛资格和奖项。
                </div>
            </div>
            <div class="sub-content-info-wrap" style="display: none;">
                <div class="sub-content-info" style="font-size: 20px;">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 报名时间即日起至2020年7月30日24:00截止，逾期不再接收报名。
                </div>
                <div class="sub-content-info" style="font-size: 20px;">
                    <img src="__HOME_IMG__/stars.png"> &nbsp; 点击大赛首页报名通道，提交报名表获取参赛编号（填写资料不可更改，请确认后再点击提交）。
                </div>
                <div class="sub-content-info" style="font-size: 20px;">
                    <img src="__HOME_IMG__/stars.png"> &nbsp;点击下方链接下载报名材料模板。
                </div>
                <div class="sub-content-info" style="font-size: 20px;">
                    <img src="__HOME_IMG__/stars.png"> &nbsp;  按照附件模板填写报名材料并上传至大赛官方指定邮箱（<span class="b-bottom">sc5gds@163.com</span>）
                </div>
                <div class="sub-content-info">
                    <span class="b-bottom" style="font-size: 20px;">报名材料模板</span>
					<a class="content-download" href="/baoming.zip" style="font-size: 20px;">点击下载</a>
                </div>
            </div>
