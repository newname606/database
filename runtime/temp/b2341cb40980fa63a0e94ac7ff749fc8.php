<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/web/189556_com/public_html/application/competition/view/user/save.html";i:1593383938;s:81:"/www/web/189556_com/public_html/application/competition/view/public/Basesave.html";i:1593348052;}*/ ?>
<!--_meta 作为公共模版分离出去-->
...
<form action="<?php echo url('User/save'); ?>" method="post" class="form form-horizontal" id="form-member-add">
    <div class="row cl">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="password" class="input-text" value="<?php echo !empty($row['password'])?$row['password'] : ''; ?>" placeholder="" id="password" name="password">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="password" class="input-text" value="<?php echo !empty($row['password2'])?$row['password2'] : ''; ?>" placeholder="" id="password2" name="password2">
        </div>
    </div>
    <div class="row cl">
