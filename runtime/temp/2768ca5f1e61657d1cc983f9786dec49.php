<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"C:\Users\gaming\Desktop\competition12\public/../application/home\view\intro\reward.html";i:1593341555;s:79:"C:\Users\gaming\Desktop\competition12\public/../application/home\view\base.html";i:1593346936;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="content">
    <div class="sub-nav-wrap">
        ...
        <a class="sub-nav sub-nav-cur" href="javascript:">奖励政策</a>
    ...
    <div class="sub-content no-crumbs">
        <div class="sub-content-info-wrap">
            <div class="sub-content-info">
                <img src="__HOME_IMG__/jiangbei.png"> &nbsp;一等奖1名，二等奖2名，三等奖3名，优秀奖6名
            </div>
            <div class="sub-content-info">
                <img src="__HOME_IMG__/jiangbei.png">&nbsp; 获奖项目被授予“四川省5G创新应用大赛”一、二、三等奖及优秀奖，并推荐参加第三届“绽放杯”5G应用征集大赛。
            </div>
            <div class="sub-content-info">
                <img src="__HOME_IMG__/jiangbei.png">&nbsp; 决赛一等奖项目技术负责人(所在单位在四川注册)，可按程序报请授予“四川省五一劳动奖章”。
            </div>
			<div class="sub-content-info">
                <img src="__HOME_IMG__/jiangbei.png">&nbsp; 对获奖项目落地实施所建设的5G基站予以资金补助支持。
			</div>
            <div class="sub-content-info">
                <img src="__HOME_IMG__/jiangbei.png">&nbsp; 获奖项目将通过本省电视、电台、报纸、网站等媒体渠道进行全程宣传推广。
            </div>
        </div>
